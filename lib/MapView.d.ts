...
declare class MapView extends React.Component<MapViewProps, State> {
    ...
    setCamera(camera: Partial<Camera>, options?: FitToOptions): void;
    animateCamera(camera: Partial<Camera>, options?: FitToOptions): void;
    animateToRegion(region: Region, duration?: number, options?: FitToOptions): void;
